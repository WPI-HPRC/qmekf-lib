...
//     Serial.println(QuaternionUtils::triad_BE(v1_b, v2_b, v1_i, v2_i));
        ...
        // Serial.println("TODO Test lla2ecef");

        // Serial.println("TODO test ecef2lla");

        // Serial.println("Test extractSub");
        // Serial.println(QuaternionUtils::extractSub(school_lla, {0, 2}));

        // Serial.println("Test extractDiag");
        // Serial.println(QuaternionUtils::extractDiag(random_mat));
