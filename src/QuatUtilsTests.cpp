...
void loop() {
        ...
        BLA::Matrix<3, 3> another_dcm = {0.8378116424161299, -0.4277690910152775, 0.33924217987147504, 0.4776732010410837, 0.8752397249354845, -0.07605088363735091, -0.26438601483276575, 0.22576321371476948, 0.9376198624677423};
        ...
        printMatHighDef(dcm2quat(another_dcm));
