...
class SplitStateEstimator {
  ...
  public:
    ...
    void setQuatNED(BLA::Matrix<4, 1> quat);
  ...
  private:
    ...
    // School: {-0.2100, 0.9500, -0.2310, 0.6391, 0.3121, 0.7030, 0.7399, 0, -0.6727}
    // IREC: {0.120664, 0.972219, 0.2005729, 0.501182, -0.234071, 0.833082, 0.8568876, 0, -0.515503};
    BLA::Matrix<3, 3> launch_dcmned2ecef = {0.120664f, 0.972219f, 0.2005729f,
                                            0.501182f, -0.234071f, 0.833082f,
                                            0.8568876f, 0f, -0.515503f};

    BLA::Matrix<3, 3> dcmned2ecef = launch_dcmned2ecef;
    // Connecticut: {1460648.839878645, -4556120.656322157, 4203563.054612514}
    // School: {1475354.0f, -4490428.0f, 4268181.0f};
    // IREC: {-1280420.9050, -5318248.5979, 3268848.6840}
    BLA::Matrix<3, 1> launch_ecef = {-1280420.9050f, -5318248.5979f, 3268848.6840f};
    // Connecticut: {41.492597, -72.224645, 0}
    // School: {31.031101, -103.536893, 0};
    BLA::Matrix<3, 1> launch_lla = {31.031101f, -103.536893f, 0f};
    ...
    BLA::Matrix<10, 1> pv_x = {0, 0, 0,
                                -1280420.9050f, -5318248.5979f, 3268848.6840f,
                                0, 0, 0,
                                0};
